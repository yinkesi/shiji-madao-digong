...
(function (ROOT) {
  ...
  const CHARS = {
    ...
    dage: { id: "dage", name: "贾瀚元", hao: "大哥", glyph: "哥", color: "#c06a2c",
      ...
      passive: { name: "城墙之梦", desc: "梦破败城墙，苔藓覆其上——梦里他有讲不完的题。" },
